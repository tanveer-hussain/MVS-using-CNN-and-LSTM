...
DatabaseLabel[773,1]=1

X_train, X_S, Y_train, Y_S = sk.train_test_split(TotalFeatures,DatabaseLabel,test_size=0.20,random_state = 50 ) #, shuffle=False


X_train, X_Validation, Y_train, Y_Validation = sk.train_test_split(X_train,Y_train,test_size=0.20,random_state = 50 ) #, shuffle=False
X_train=X_train
Y_train=Y_train
...
#        print(sess.run(weights))
        ...
        for epoch in range(hm_epochs):
            ...
            if  accuracy_out > best_accuracy:
                    ...
                    save_path = saver.save(sess, "Trained Model/model.chk")
